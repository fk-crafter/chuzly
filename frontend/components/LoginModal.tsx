...
export function LoginModal() {
  ...
  return (
    <div className="w-full max-w-xs md:max-w-sm mx-auto">
      ...
      {/* Mobile Version */}
      <div className="block md:hidden relative z-10 bg-white dark:bg-zinc-900 rounded-lg shadow-lg p-5 pt-10 text-center space-y-6 border border-border">
        <ShineBorder shineColor={["#A07CFE", "#FE8FB5", "#FFBE7B"]} />
        ...
        <div className="text-lg font-semibold">Welcome to Chuzly</div>
        ...
        <div className="space-y-3">
          ...
          <div className="relative w-full">
            <Button
              variant="outline"
              className="w-full flex items-center justify-center opacity-50 cursor-not-allowed py-3 text-sm"
              disabled
            >
              <FaApple className="text-xl" />
              Continue with Apple
